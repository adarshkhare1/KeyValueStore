...
public class UpdateTask implements Callable<StorageResult>
{
    private static final Logger _LOGGER;

    static
    {
        _LOGGER = LogManager.getLogger(UpdateTask.class.getName());
    }
    ...
    public UpdateTask(StoragePartition p, long key, StorageBlob value){
    ...
    {
        try {
            _partition.update(_key, _value);
        }
        catch (StorageException e) {
            _LOGGER.fatal("Failed to update key {}.", _key);
